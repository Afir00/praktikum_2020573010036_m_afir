...
<head>
    ...
    <title>Profil Website Admin Your Management</title>
</head>
                    ...
                    <div class="card-body">
                        <form disabled>
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="email" value="<?= $data['username']; ?>" disabled>
                            ...
                            <a href="../yonko/headers/headers.php" class="btn btn-outline-secondary">
                                kembali
                            </a>
                            <button type="submit" class="btn btn-primary me-2 btn-dark">Perbaharui</button>
                        </form>
                    </div>
                </div>
            </div>
