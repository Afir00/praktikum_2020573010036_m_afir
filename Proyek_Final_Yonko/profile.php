...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <form disabled >
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="email" aria-describedby="emailHelp" value="<?= $row['username']; ?>" disabled> */
                                    <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                                </div>
                                <div class="mb-3">
                                    <label for="level" class="form-label" >Nama Toko</label>
            ...
            <!-- Footer -->
            <?php require 'component/footers.php' ?>
            <!-- End Footer -->
        </div>
        <!-- End Sidebar -->
